...
class SchedulerService:
    ...
    def __init__(self):
        ...
        return "Scheduler_v1.0_" + datetime.now().strftime('%Y%m%d')
    ...
    async def create_maintenance_schedule(self, asset_id: int, report_id: int, 
        ...
        try:
            ...
            hours_to_add = urgency_hours.get(priority, 24)
    ...
    async def update_maintenance_priority(self, asset_id: int, report_id: int, new_priority: str):
        ...
        try:
            ...
            hours_to_add = urgency_hours.get(new_priority, 24)
            ...
            return {"success": False, "error": str(e)}     'MEDIUM': int(os.getenv('MEDIUM_RISK_SLA', 72)),  # 72 jam  
